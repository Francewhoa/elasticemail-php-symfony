...
class CampaignOptionsTest extends TestCase
{
    ...
    {
        $testCampaignOptions = new CampaignOptions();
    }

    /**
     * Test attribute "deliveryOptimization"
     */
