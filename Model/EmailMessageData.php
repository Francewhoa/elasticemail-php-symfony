...
/**
 * Class representing the EmailMessageData model.
 *
 * Email data
 *
 * @package ElasticEmail\Model
...
class EmailMessageData 
{
     ...
     *
     * @var ElasticEmail\Model\EmailRecipient[]|null
     * @SerializedName("Recipients")
     * @Assert\All({
     *   @Assert\Type("ElasticEmail\Model\EmailRecipient")
     * })
     * @Type("array<ElasticEmail\Model\EmailRecipient>")
     */
     ...
     * Gets recipients.
     *
     * @return ElasticEmail\Model\EmailRecipient[]|null
     */
     ...
     * Sets recipients.
     *
     * @param ElasticEmail\Model\EmailRecipient[]|null $recipients  List of recipients (visible to others)
     *
     * @return $this
     */
