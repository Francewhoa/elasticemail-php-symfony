...
/**
 * Class representing the FilePayload model.
 *
 * @package ElasticEmail\Model
 * @author  OpenAPI Generator team
 */
class FilePayload 
{
     ...
     * Sets binaryContent.
     *
     * @param string|null $binaryContent  Content of the file sent as binary data
     *
     * @return $this
     */
     ...
     * Sets contentType.
     *
     * @param string|null $contentType  Type of file's content (e.g. image/jpeg)
     *
     * @return $this
     */
