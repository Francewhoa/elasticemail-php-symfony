...
/**
 * Class representing the SubaccountEmailSettings model.
 *
...
class SubaccountEmailSettings 
{
     ...
     * @Type("int")
     */
    protected $monthlyRefillCredits;
    ...
    {
        $this->monthlyRefillCredits = isset($data['monthlyRefillCredits']) ? $data['monthlyRefillCredits'] : null;
    ...
    /**
     * Gets monthlyRefillCredits.
     *
     * @return int|null
     */
    public function getMonthlyRefillCredits()
    {
        return $this->monthlyRefillCredits;
    }

    /**
     * Sets monthlyRefillCredits.
     *
     * @param int|null $monthlyRefillCredits  Amount of credits added to Account automatically
     *
     * @return $this
     */
    public function setMonthlyRefillCredits($monthlyRefillCredits = null)
    {
